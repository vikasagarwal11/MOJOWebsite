      ...
      (snapshot) => {
        const records: Testimonial[] = snapshot.docs.map((docSnapshot) => {
          ...
          return {
            ...
            toneLabel: data.toneLabel ?? undefined,
            toneConfidence: typeof data.toneConfidence === 'number' ? data.toneConfidence : undefined,
            toneKeywords: Array.isArray(data.toneKeywords) ? data.toneKeywords : undefined,
