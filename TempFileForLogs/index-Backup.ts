...
// Set global options for all functions - using us-central1 to match Eventarc channels
...
export const onMediaFileFinalize = storage.object().onFinalize(async (object) => {
