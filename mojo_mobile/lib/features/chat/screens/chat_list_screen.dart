...
// =============================================================================
// ChatListScreen — next-gen community chat list
// =============================================================================
...
// =============================================================================
// _ChatRoomTile — individual room row with swipe actions & long-press menu
// =============================================================================
    ...
    return Dismissible(
      ...
      confirmDismiss: (direction) async {
        ...
        if (direction == DismissDirection.startToEnd) {
          // Pin / Unpin
          if (isPinned) {
            // unpinRoom not in service — just call pinRoom as toggle
...
// =============================================================================
// _TypingDots — animated three-dot indicator
// =============================================================================
