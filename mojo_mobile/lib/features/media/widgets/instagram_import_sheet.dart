...
class _InstagramImportBodyState extends State<_InstagramImportBody> {
  ...
  Future<void> _onTapItem(InstagramMediaItem item) async {
    ...
    showDialog<void>(
      ...
      builder: (c) => const Center(child: AppLoadingIndicator(color: MojoColors.primaryOrange)),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              'then generate a shortâ€‘lived user token with instagram_graph_user_media (or Basic Display equivalent). '
              'Do not ship longâ€‘lived tokens inside the app â€” prefer server-side OAuth for production.',
