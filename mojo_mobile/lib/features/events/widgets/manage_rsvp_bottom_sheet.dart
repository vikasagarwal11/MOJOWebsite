...
class _ManageRsvpSheetState extends ConsumerState<_ManageRsvpSheet> {
  ...
  String get _status => (_d['rsvpStatus'] as String?) ?? 'â€”';
  ...
  Future<bool> _confirmPaidNotGoing() async {
    final r = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'You paid for this event. Changing to â€œNot goingâ€ does not automatically refund your payment. '
          'Continue?',
        ),
        actions: [
          TextButton(
        ...
        child: Column(
          ...
          children: [
            ...
            if (isPast) ...[
              const SizedBox(height: 16),
              Text(
                'This event has ended â€” RSVP canâ€™t be changed.',
