...
class _CreatePostSheetState extends ConsumerState<CreatePostSheet> {
  ...
  Future<void> _submit() async {
    ...
    if (content.length < 10 || content.length > 2000) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Content must be 10â€“2000 characters.')),
      );
      return;
    }
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: _pickedImagePath != null ? 'Image URL (disabled â€” photo attached)' : 'Or paste image URL',
            ...
            FilledButton(
              ...
              child: _submitting
                  ? const SizedBox(height: 22, width: 22, child: AppLoadingIndicator(strokeWidth: 2))
