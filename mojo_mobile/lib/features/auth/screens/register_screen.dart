...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  static const _hearOptions = [
    'facebook', 'instagram', 'tiktok', 'referred_by_member', 'friend', 'family', 'google_search', 'other'
  ];
      ...
      await auth.startPhoneVerification(
        ...
        verificationCompleted: (credential) async {
          ...
          try {
            ...
            final result = await auth.signInWithPhoneCredential(credential, requireUserDocument: false);
            if (mounted) {
              setState(() {
  ...
  Future<void> _submitAdditionalInfo() async {
    ...
    try {
      ...
      await ref.read(authServiceProvider).createPendingUser(
        ...
        howDidYouHearOther: _howDidYouHear == 'other' ? _howDidYouHearController.text.trim() : null,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Join Our Community', style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              _step == _RegisterStep.phone ? 'Create your account to start your fitness journey' :
              _step == _RegisterStep.code ? 'Enter the verification code sent to your phone' :
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (v) {
                        ...
                        if (normalizeUSPhoneToE164OrNull(v) == null) return 'Must be a valid US number';
                        return null;
                      },
                    ),
                    const SizedBox(height: 16),
                    ...
                    Row(
                      children: [
                        Expanded(
                          flex: 1,
                          child: TextButton(
                            onPressed: _loading ? null : () => setState(() => _step = _RegisterStep.phone),
                ...
                child: Column(
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: _hearOptions.map((e) => DropdownMenuItem(
                        value: e,
                        child: Text(e.replaceAll('_', ' ').toUpperCase()),
                      )).toList(),
                      onChanged: (val) => setState(() => _howDidYouHear = val ?? 'facebook'),
                    ),
