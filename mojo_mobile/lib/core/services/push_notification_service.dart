...
class PushNotificationService {
  ...
  Future<void> syncTokenForUser(FirebaseFirestore firestore, String uid) async {
    ...
    try {
      ...
      if (!ok) {
        appLogger.w('FCM permission not granted: ${settings.authorizationStatus}');
        return;
      }
  ...
  Future<void> _persistToken(FirebaseFirestore firestore, String uid, String token) async {
    try {
