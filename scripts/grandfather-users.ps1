...
Write-Host "   3. Call this from the browser console (see DEPLOYMENT_ACCOUNT_APPROVAL.md)" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "3. Run the code from DEPLOYMENT_ACCOUNT_APPROVAL.md" -ForegroundColor White
Write-Host ""
